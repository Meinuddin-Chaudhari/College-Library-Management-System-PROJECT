...
@WebFilter(filterName="librarianRegistration",urlPatterns ="/librarianRegistration.jlc")
public class AdminEmailIdFilter extends IneuronBase implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// TODO Auto-generated method stub
			...
			List<AdminEmailIdTO> adminEmailIdList=adminEmailIdService.getAllAdminEmailId();
			for(AdminEmailIdTO adminEmailIdTO:adminEmailIdList) {
				//System.out.println("adminEmailId >>>> "+adminEmailIdTO.getEmailId());
				if(adminEmailIdTO.getEmailId().equals(email)) {
					isValidEmailId=true;
					break;
				}
		...
		if(isValidEmailId){
			...
			RequestDispatcher rd=request.getRequestDispatcher("RegisterLibrarian.jsp");
